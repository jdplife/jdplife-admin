package com.jdplife.gen.service.impl;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.jdplife.gen.entity.DatabaseColumn;
import com.jdplife.gen.entity.DatabaseTable;
import com.jdplife.gen.entity.GenTable;
import com.jdplife.gen.entity.GenTableColumn;
import com.jdplife.gen.mapper.GenTableColumnMapper;
import com.jdplife.system.entity.SysMenu;
import com.jdplife.gen.mapper.GenTableMapper;
import com.jdplife.system.mapper.SysMenuMapper;
import com.jdplife.system.entity.SysRole;
import com.jdplife.system.entity.SysRoleMenu;
import com.jdplife.system.mapper.SysRoleMapper;
import com.jdplife.system.mapper.SysRoleMenuMapper;
import com.jdplife.gen.service.GenTableService;
...
public class GenTableServiceImpl implements GenTableService {
    ...
    public void importTable(String[] tableNames) {
        for (String tableName : tableNames) {
            ...
            table.setPackageName("com.jdplife.biz");
    ...
    public List<String> previewGenerateFiles(Long tableId) {
        ...
        if (projectRoot.endsWith("jdplife-web")) {
    ...
    public List<String> generateToProject(Long tableId) {
        ...
        // 获取项目根目录
        String projectRoot = System.getProperty("user.dir");
        // 如果是在 jdplife-web 目录下运行，需要找到项目根目录
        if (projectRoot.endsWith("jdplife-web")) {
            projectRoot = projectRoot.substring(0, projectRoot.length() - 8);
        }
    ...
    private String getProjectFilePath(GenTable table, String fileName, String projectRoot) {
        ...
        return switch (fileName) {
            case "Entity.java" -> projectRoot + "/jdplife-core/jdplife-biz/src/main/java/com/jdplife/biz/entity/" + className + ".java";
            case "Mapper.java" -> projectRoot + "/jdplife-core/jdplife-biz/src/main/java/com/jdplife/biz/mapper/" + className + "Mapper.java";
            case "Service.java" -> projectRoot + "/jdplife-core/jdplife-biz/src/main/java/com/jdplife/biz/service/" + className + "Service.java";
            case "ServiceImpl.java" -> projectRoot + "/jdplife-core/jdplife-biz/src/main/java/com/jdplife/biz/service/impl/" + className + "ServiceImpl.java";
            case "Controller.java" -> projectRoot + "/jdplife-core/jdplife-biz/src/main/java/com/jdplife/biz/controller/" + className + "Controller.java";
            case "api.ts" -> projectRoot + "/jdplife-ui/src/api/" + businessName + ".ts";
            case "index.vue" -> projectRoot + "/jdplife-ui/src/views/" + moduleName + "/" + businessName + "/index.vue";
