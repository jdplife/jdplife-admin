      ...
      <n-gi>
        <n-card title="系统信息" class="system-card">
          <n-descriptions :column="1" label-placement="left">
            <n-descriptions-item label="系统名称">jdplife Admin</n-descriptions-item>
        ...
        <n-card title="关于作者" class="author-card">
          <div class="author-content">
            <div class="author-avatar">
              <n-avatar
                  round
                  :size="80"
                  src="https://foruda.gitee.com/avatar/1692522394185109890/4768152_jdplifefactory_1692522394.png!avatar30"
              >
              </n-avatar>
            </div>
            <div class="author-info">
              <h3 class="author-name">程序员jdplife</h3>
              <p class="author-desc">开源作者全栈开发，抖音技术博主，专注于后台管理系统的开发与优化。</p>
              <div class="author-links">
                <n-space>
                  <a href="https://gitee.com/jdplifefactory/jdplife-admin" target="_blank" class="author-link">
                    <n-icon size="16">
                      <LogoGitlab/>
                    </n-icon>
                    <span>Gitee</span>
                  </a>
                  <a href="https://jdplife-coder.cn/" target="_blank" class="author-link">
                    <n-icon size="16">
                      <Globe/>
                    </n-icon>
                    <span>火星编程导航</span>
          ...
          <div class="project-info">
            <p class="project-desc">
              jdplife Admin 是一个基于 Spring Boot 3 + Vue 3 的现代化后台管理系统，
...
const changelog = [
  ...
  },
  {
    ...
    changes: [
      ...
      'jdplife-push 模块重构：支持文本和图片，统一 Webhook 发送逻辑',
